...
class DataLoader_TableArithmetic(object):
...
def generate_qa(
    ...
    question = 'Is 8.9 larger than 8.11? Generate "final answer: x" where x is the larger number without other texts.'
    question = 'Is 327.9 larger than 327.11? Generate "final answer: x" where x is the larger number without other text.'
    question = f'Is {x+0.9} larger than {x+0.11}? Generate "final answer: x" where x is the larger number without other text.'
    question = f'Is {x+0.9} larger than {x+0.11}?'
    question = f'What is {x}+(9.9>9.11)?'
    question = f'What is {x}+(10.9>10.11)?'
    answer = x+1
